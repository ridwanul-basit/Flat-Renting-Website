...
<div class="pagination">
    <a href="index.php" ><button>First</button></a>
    <?php
...
<div class="page_num">
    <?php
      for($counter = 1; $counter <= $pages; $counter++){
        ?>
        <a href="?page-nr=<?= $counter?>" <?php if ($page ==="index.php?page-nr= $counter") {?> class="activeLink" <?php }  ?>><button><?= $counter; ?></button></a>
        <?php
      }
    ?>
