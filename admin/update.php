...
include 'config/cd.php';
    ...
    if(isset($_GET['id2'])){
        $id=$_GET['id2'];
        $query= "SELECT * from flat where flat_id ='$id'";
...
<body>
    <form action="update.php?new_id=<?php echo $id?>" method="post">
      <div class="form-group">
       ...
       <input type="text" name="statu" class="form-control" value="<?php echo $row['status']; ?>">
...
<?php
 if(isset($_POST['update_status'])){
    ...
    $st=$_POST['statu'];
    $query="UPDATE flat SET status='$st' where flat_id='$n_id'";
