...
<body>
    <form action="update2.php?new_id=<?php echo $id?>" method="post">
      <div class="form-group">
       <label for="status">Status</label>
       <input type="text" name="statu" class="form-control" value="<?php echo $row['agent_id']; ?>">
...
<?php
 if(isset($_POST['update_status'])){
    ...
    $st=$_POST['statu'];
    $query="UPDATE appointment SET agent_id='$st' where user_id='$n_id'";
