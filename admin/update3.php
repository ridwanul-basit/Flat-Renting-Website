...
<body>
    <form action="update3.php?new_id=<?php echo $id?>" method="post">
      <div class="form-group">
       <label for="appointment_status">Appointment Status</label>
       <input type="text" name="statu" class="form-control" value="<?php echo $row['appointment_status']; ?>">
       <input type="submit" class="btn btn-success" name="update_status" value="Update">
      </div>
</form>
...
<?php
 if(isset($_POST['update_status'])){
    ...
    $st=$_POST['statu'];
    $query="UPDATE appointment SET appointment_status='$st' where user_id='$n_id'";
